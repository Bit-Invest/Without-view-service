  ...
  return (
    <div className={buildRootClass()}>
      <div className={`${ROOT_CLASS}__avatar-wrap`}>
        <Avatar
          imageSrc={avatarArr[props.imageSrc] ? avatarArr[props.imageSrc] : DefaultIcon}
          theme={props.theme}
          isIdentityVerification={props.isIdentityVerification}
        />
      </div>
          ...
          { !props.theme ?
            <div className={`${ROOT_CLASS}__approved`}>
              { !props.isIdentityVerification ?
                <div className={`${ROOT_CLASS}__approved-span-button`}>
                  <span>Pass KYC with: </span>
